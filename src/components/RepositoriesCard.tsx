...
export function RepositoriesCard({
  ...
  return (
    <div className="flex justify-center items-center">
      <div className="flex flex-col bg-gray-700 p-8 rounded-lg border border-solid border-gray-500 items-start gap-4 w-5/6 md:w-1/2 md:h-1/2 mb-4">
        ...
        <Link
          to={html_url}
          target="_blank"
          className="text-center bg-yellow-800 px-4  py-4  mt-2 rounded-xl text-gray-950 font-bold text-sm uppercase hover:bg-yellow-600 leading-tight"
        >
